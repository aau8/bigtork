...
<html lang="en">
	...
	<body>
		<div class="wrapper">
				...
				<div class="breadcrumbs">
					<div class="breadcrumbs__container">
						<ul class="breadcrumbs__list">
							...
							<li class="breadcrumbs__item">Качество</li>
						</ul>
					</div>
				</div>
					...
					<div class="main-info">
						<div class="main__content">
							<h1 class="title-1 main__title">
								Complete <span>control system application</span> environment
							</h1>
							<p class="main__text">
			...
			<div class="content">
				<div class="section s-advant">
					<div class="s-advant__container">
						<div class="s-advant__body">
							<div class="c-advant">
								<div class="c-advant__wrap">
									<div class="c-advant__img">
										<img src="./assets/img/company-development.jpg" alt="" />
									</div>
									<div class="c-advant__content">
										<span class="title-2 c-advant__title"
											>Design <span>Assurance System</span></span
										>
										<p class="c-advant__text">
											With the most advanced design and selection software, you can obtain
											relevant materials and system diagrams such as equipment copper pipes,
											splitters, signal lines, and additional refrigerants.
										</p>
									</div>
								</div>
							</div>
							<div class="c-advant">
								<div class="c-advant__wrap">
									...
									<div class="c-advant__content">
										<span class="title-2 c-advant__title"
											>Construction <span>Security</span> System</span
										>
										<p class="c-advant__text">
											Bigtork has always focused on the sales, production, R&D and design of
											pneumatic actuators for industrial process control valves, and has signed
											long-term ORM cooperation services with foreign automatic valve companies.
										</p>
									</div>
								</div>
							</div>
							<div class="c-advant">
								<div class="c-advant__wrap">
									...
									<div class="c-advant__content">
										<span class="title-2 c-advant__title"
											>After-sales <span>Guarantee System</span></span
										>
										<p class="c-advant__text">
											Bigtork has always focused on the sales, production, R&D and design of
											pneumatic actuators for industrial process control valves, and has signed
							...
							<div class="c-advant">
								<div class="c-advant__wrap">
									...
									<div class="c-advant__content">
										<span class="title-2 c-advant__title"
											>Training <span>Guarantee</span> System</span
										>
										<p class="c-advant__text">
											The construction and maintenance personnel of the franchise store can obtain
											the qualification certificate after passing the systematic training.
										</p>
									</div>
								</div>
							</div>
